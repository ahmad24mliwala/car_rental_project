<?php
	...
	if(isset($_SESSION['username_ahmad_car_rental']) && isset($_SESSION['password_ahmad_car_rental']))
	{
				...
				<?php
					...
					if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['signin-button']))
					{
						...
						if($count > 0)
						{
							...
							$_SESSION['username_ahmad_car_rental'] = $username;
							$_SESSION['password_ahmad_car_rental'] = $password;
							$_SESSION['user_id_ahmad_car_rental'] = $row['user_id'];
							header('Location: dashboard.php');
							die();
						}
						else
		...
		<footer class="sticky-footer bg-white">
			<div class="container my-auto">
		  		<div class="copyright text-center my-auto">
					<span>Copyright &copy; Car Rental Website by AhmAd 2022</span>
		  		</div>
			</div>
	  	</footer>
		<!-- End of Footer -->
