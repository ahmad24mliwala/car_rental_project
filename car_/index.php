        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-feature">
                    ...
                    <p>
                    We have fully maintain cars with GPS and other techolgies for our client flexible and safe journy.
                    </p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="single-feature">
                    ...
                    <p>
                    We have 24*7 technician team for any emergency or problem occurs in cars they are always ready for repairing in car.
                    </p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="single-feature">
                    ...
                    <p>
                    Cancel or change most bookings for free up to 48 hours before pick-up and no hidden fess or extra charges.
                    </p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="single-feature">
                    ...
                    <p>
                    We’re working with our partners to keep you safe and your safely journy with fully sanitized and vaccinated staff. with premium insurance cover.
                    </p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="single-feature">
                    ...
                    <p>
                        The app is as user friendly policies with many offers and coupons. The booking process is as easy as nursary rhyme. Nicely maintain cars.
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="footer_widget">
                    <a class="navbar-brand" href="">
                        Ahm<span style = "color:#04DBC0">Ad</span>&nbsp;CarRental
                    </a>
                    <p>
                        Getting dressed up and traveling with good friends makes for a shared, unforgettable experience.
                    </p>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="footer_widget">
                    ...
                    <ul class = "contact_info">
                        <li>
                            <i class="fas fa-map-marker-alt"></i>122 First Avenue, East Street INDIA,220022
                        </li>
                        <li>
                            <i class="far fa-envelope"></i>contact@ahmadcar.com
                        </li>
                        <li>
