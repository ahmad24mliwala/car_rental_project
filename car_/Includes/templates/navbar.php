...
<header  id="header" class="nav-header">
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class = "container">
            ...
            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#AhmadNavbar" aria-controls="AhmadNavbar" aria-expanded="false" aria-label="Toggle navigation">
                <span class="navbar-toggler-icon"></span>
            </button>
            <div class="collapse navbar-collapse" id="ahmadNavbar">
                <ul class="navbar-nav" style = "margin-left: auto!important;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/car_/admin/index.php" target="_blank">Admin</a> 
                    </li>
                </ul>
            </div>
        </div>
